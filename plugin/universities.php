    ...
    ?>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat" id="categoriesTable" style="margin-bottom:0px;" data-object="university">
            <tr>
        ...
        <?php 
            foreach($schools as $school) {
                ...
                $abbr = $objSchool->getSchoolAbbr($school['id']);
        ?>
            <tr data-id="<?php echo $school['id']; ?>"> 
                <td class=" borderRight showInputField clickable" data-field="name" style="width:auto;">
